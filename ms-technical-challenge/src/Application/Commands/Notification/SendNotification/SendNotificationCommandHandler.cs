namespace SB.TechnicalChallenge.Application.Commands.Notification.SendNotification;
...
public class SendNotificationCommandHandler : IRequestHandler<SendNotificationCommand, bool>
{
    ...
    {
        await _hubContext.Clients.Client(request.ConnectionId).SendAsync("messageReceived", request.User, request.Message);
        return true;
    }
}
